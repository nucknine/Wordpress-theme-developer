...
if (!function_exists('ale_map')) {
            ...
            <script type="text/javascript">
                ...
                function ale_run_map_<?php echo $map_id ; ?>(){
                    ...
                    var marker = new google.maps.Marker({
                        ...
                        position: location,
                        clickable: true,
        				title:"Создай свой курс!",
                        map: map_<?php echo $map_id ; ?>
                    });
                    var contentString = '<div id="content">Добро пожаловать!</div>';
    ...
    function ale_map_load_scripts() {
        ...
        wp_register_script( 'google-maps-api', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyDlOwPZ9wX7DrA5C_QxS7PQ-5vzFXTHmlE&amp;' );
    }
