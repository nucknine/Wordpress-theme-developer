...
function ale_enqueue_styles() {
    ...
    wp_register_style( 'aletheme_libs_css', THEME_URL . '/css/libs.min.css', array(), ALETHEME_THEME_VERSION, 'all');
    wp_register_style( 'aletheme_main_css', THEME_URL . '/css/main.css', array(), ALETHEME_THEME_VERSION, 'all');

    wp_enqueue_style('aletheme_libs_css');
...
//	wp_register_script( 'ale_modernizr', THEME_URL . '/js/libs/modernizr-2.5.3.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, false );
    ...
    wp_register_script( 'ale_libs', THEME_URL . '/js/libs.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'ale_scripts', THEME_URL . '/js/common.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    // wp_register_script( 'ale_loc', THEME_URL . '/js/myLoco.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
//    wp_register_script( 'ale_location', THEME_URL . '/js/myLoc.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );

    wp_enqueue_script( 'ale_libs' );
	wp_enqueue_script( 'ale_scripts' );
    // wp_enqueue_script( 'ale_loc' );
